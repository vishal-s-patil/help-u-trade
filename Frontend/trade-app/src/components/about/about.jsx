...
class About extends Component {
    ...
    handleref = (id) => {
        window.scrollTo({
            top : this["ref_" + id + ""].current.offsetTop,
            behavior : "smooth"
        });
    }
        ...
        return (
            <React.Fragment>
                ...
                <div className="skipTo">
                    <h4 onClick={() => this.handleref(1)}>What is Stock Market?</h4>
                    <h4 onClick={() => this.handleref(2)}>Understanding the Stock Market</h4>
                    <h4 onClick={() => this.handleref(3)}>Special Considerations</h4>
                    <h4 onClick={() => this.handleref(4)}>Functions of a Stock Market</h4>
                    <h4 onClick={() => this.handleref(5)}>Fair Dealing in Securities Transactions</h4>
                    <h4 onClick={() => this.handleref(6)}>Efficient Price Discovery</h4>
                    <h4 onClick={() => this.handleref(7)}>Liquidity Maintenance</h4>
                    <h4 onClick={() => this.handleref(8)}>Security and Validity of Transactions</h4>
                    <h4 onClick={() => this.handleref(9)}>Support All Eligible Types of Market Participants</h4>
                    <h4 onClick={() => this.handleref(10)}>Investor Protection</h4>
                    <h4 onClick={() => this.handleref(11)}>Balanced Regulation</h4>
                    <h4 onClick={() => this.handleref(12)}>Regulating the Stock Market</h4>
                    <h4 onClick={() => this.handleref(13)}>Competition Faced by Stock Markets</h4>
                </div>
            <div className="aboutContainer">
                <h1 >About Stock Market</h1>

                <h3 ref={this.ref_1}>What is Stock Market?</h3>
                ...
                <h3  ref={this.ref_2} style={{marginTop : "20px"}}>Understanding the Stock Market</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_3} style={{marginTop : "20px"}}>Special Considerations</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_4} style={{marginTop : "20px"}}>Functions of a Stock Market</h3>
                <p style={{marginTop : "10px"}}>
                A stock market primarily serves the following main functions:
                </p>
                <h3  ref={this.ref_5} style={{marginTop : "20px"}}>Fair Dealing in Securities Transactions</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_6} style={{marginTop : "20px"}}>Efficient Price Discovery</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_7} style={{marginTop : "20px"}}>Liquidity Maintenance</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_8} style={{marginTop : "20px"}}>Security and Validity of Transactions</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_9} style={{marginTop : "20px"}}>Support All Eligible Types of Market Participants</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_10} style={{marginTop : "20px"}}>Investor Protection</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_11} style={{marginTop : "20px"}}>Balanced Regulation</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_12} style={{marginTop : "20px"}}>Regulating the Stock Market</h3>
                <p style={{marginTop : "10px"}}>
                ...
                <h3  ref={this.ref_13} style={{marginTop : "20px"}}>Competition Faced by Stock Markets</h3>
                <p style={{marginTop : "10px"}}>
